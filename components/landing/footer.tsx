...
export function LandingFooter() {
  return (
    <footer className="bg-background-subtle border-t border-border py-16 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div>
            ...
            <p className="text-foreground-muted text-sm">
              AI-powered social media content generation for modern teams.
            </p>
          </div>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-foreground-muted text-sm">© 2025 binj.Ai. All rights reserved.</p>
